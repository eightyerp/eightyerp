...
import type { ExpenseDocumentRecord, ExpenseNotificationItem, ExpenseProjectOption, ExpenseRequestRecord, VendorRecord } from "@/lib/crm/expense-shared";
...
export const registerExpenseRequest = (input: Record<string, unknown>) => rpc<{ expense_id: string; status: string; project_id: string; customer_id: string | null; requester_employee_id: string | null; amount: number }>("register_expense_request", {
